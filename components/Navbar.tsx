  ...
  return (
    <header className="fixed top-0 left-0 w-full z-50">
      <div className="mx-auto max-w-6xl px-4 sm:px-6 pt-4">
        <div className="relative rounded-2xl border border-white/10 bg-black/35 backdrop-blur-xl shadow-glow">
          ...
          <nav className="relative flex items-center justify-between gap-3 px-4 sm:px-5 py-3">
            <Link
              href="/"
        ...
        {open && (
          ...
          >
            ...
            <motion.div
              ...
              className="absolute left-1/2 top-4 w-[calc(100%-2rem)] -translate-x-1/2 rounded-2xl border border-white/10 bg-black/60 backdrop-blur-xl p-3 shadow-glow"
            >
