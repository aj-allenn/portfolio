  ...
  return (
    <section className="py-24" id="experience">
      <div className="max-w-5xl mx-auto px-6">
        <Reveal>
          <h2 className="text-4xl sm:text-5xl font-semibold tracking-tight text-white mb-16 text-center">
            Experience
          </h2>
        </Reveal>
        ...
        <div className="space-y-12">
          {experiences.map((exp, index) => (
            ...
            >
              <span className="absolute -left-[7px] top-1.5 w-3.5 h-3.5 rounded-full bg-gradient-to-r from-cyan-300 to-purple-400 shadow-[0_0_0_4px_rgba(255,255,255,0.06)]" />
